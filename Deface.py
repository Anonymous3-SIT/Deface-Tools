...
echo
echo
cowsay -f eyes "SHUTDOWN INDO TEAM" | lolcat
echo
...
echo 'WhatsApp : 628999271792' | lolcat
echo 'Gmail    : anonymoussit36@gmail.com' | lolcat
echo
echo '''
SCRIPT INI BERFUNGSI UNTUK MENDEFACE WEBSITE
YANG VULN / RENTAN TERHADAP BUG DEFACE
''' | lolcat
echo
echo 'Example : index.html' | lolcat
...
TERSEBUT VULN. JIKA TIDAK, CARI TARGET
YANG LAIN :)
''' | lolcat
